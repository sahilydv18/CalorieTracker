        ...
        Column(
            ...
            Row(
                ...
                Column (
                    ...
                    NutritionalInfo(title = R.string.total_calorie, value = totalCalorie, unit = R.string.calorie_unit)
                    Spacer(modifier = Modifier.height(8.dp))
                    NutritionalInfo(title = R.string.total_carbs, value = totalCarbs, unit = R.string.gram_unit)
                }
                Spacer(modifier = Modifier.weight(1f))
                Column (
                    modifier = Modifier.padding(top = 8.dp)
                ) {
                    NutritionalInfo(title = R.string.total_protein, value = totalProtein, unit = R.string.gram_unit)
                    Spacer(modifier = Modifier.height(8.dp))
                    NutritionalInfo(title = R.string.total_fat, value = totalFat, unit = R.string.gram_unit)
                }
            }
...
private fun IngredientCard(ingredient: Ingredient) {
    Card(
        ...
        Column(
            ...
            Row {
                Column {
                    NutritionalInfo(title = R.string.calorie_ingredient, value = ingredient.calories, unit = R.string.calorie_unit)
                    Spacer(modifier = Modifier.height(8.dp))
                    NutritionalInfo(title = R.string.carbs_ingredient, value = ingredient.carbs, unit = R.string.gram_unit)
                }
                Spacer(modifier = Modifier.weight(1f))
                Column {
                    NutritionalInfo(title = R.string.protein_ingredient, value = ingredient.protein, unit = R.string.gram_unit)
                    Spacer(modifier = Modifier.height(8.dp))
                    NutritionalInfo(title = R.string.fat_ingredient, value = ingredient.fat, unit = R.string.gram_unit)
                }
            }
        }
    }
